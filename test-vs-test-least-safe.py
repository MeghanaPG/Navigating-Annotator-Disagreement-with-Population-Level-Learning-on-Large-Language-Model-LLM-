...
def main():
    ...
    X_train, X_val, X_test, y_train, y_val, y_test, embeddings_train, embeddings_val, embeddings_test = split_dataset("least_safest_labels_dataset.csv")
    X_train2, X_val2, X_test2, y_train2, y_val2, y_test2, embeddings_train2, embeddings_val2, embeddings_test2 = split_dataset("majority_labels_dataset.csv")
    ...
    # plt.title('Confusion Matrix - Test vs test Least safest label - Safest label')
    # Save the plot as an image file
    # plt.savefig('confusion_matrix_test-vs-test-least_safest-safest.png')
    plt.title('Confusion Matrix - Test vs test Least safest label - Majority label')
    # Save the plot as an image file
    plt.savefig('confusion_matrix_test-vs-test-least_safest-majority.png')
    plt.close()
