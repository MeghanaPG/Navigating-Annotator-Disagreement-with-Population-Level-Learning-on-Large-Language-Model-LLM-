...
def main():
    ...
    X_train, X_val, X_test, y_train, y_val, y_test, embeddings_train, embeddings_val, embeddings_test = split_dataset("majority_labels_dataset.csv")
    ...
    # plt.title('Confusion Matrix - Test vs test Majority label - Safest label')
    # # # Save the plot as an image file
    # plt.savefig('confusion_matrix_test-vs-test-majority-safest.png')
    plt.title('Confusion Matrix - Test vs test Majority label - Least safest label')
    # Save the plot as an image file
    plt.savefig('confusion_matrix_test-vs-test-majority-least_safest.png')
    plt.close()
