...
def split_dataset():
    ...
    # dataset = dataset.sample(200, random_state=42)
...
def main():
    ...
    plt.title('Least safest labels train and test')
    # Save the plot as an image file
    plt.savefig('confusion_matrix-Least safest.png')
    # plt.title('Confusion Matrix - Trained on Least safest label - Tested on Safest label')
    # # Save the plot as an image file
    # plt.savefig('confusion_matrix_Least-safest-safest.png')
    # plt.title('Confusion Matrix - Trained on Least safest label - Tested on Majority label')
    # # Save the plot as an image file
    # plt.savefig('confusion_matrix_Least-safest- Majority.png')
    plt.close()
